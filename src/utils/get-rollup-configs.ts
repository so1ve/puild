...
import type { AliasMap, ExportEntry } from "../types";
import { createRequire, isFormatEsm } from "./rollup-plugins/create-require";
import { esbuildMinify, esbuildTransform } from "./rollup-plugins/esbuild";
...
const getConfig = {
  async type (
    ...
    return {
      ...
      output: [] as OutputOptions[] & { [key: string]: any },
